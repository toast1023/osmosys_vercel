...
const AddServerOption = ({}) => {
  return (
    <li>
      <a className="text-gray-500" onClick={() => {return onClickBlur();}} target="_blank"
      href="https://discord.com/oauth2/authorize?client_id=1152436728125206628&permissions=21983791152192&scope=bot">
